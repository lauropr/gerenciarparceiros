		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#z99gerenciarparceiros-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"z99gerenciarparceiros-display": {
								"semanticObject": "z99gerenciarparceiros",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z99.gerenciarparceiros",
									"url": sap.ui.require.toUrl("z99/gerenciarparceiros")
								}
							}
						}
					}
